...
var (
	PE_MAGIC_BYTES = []byte{'P', 'E', 0, 0}
)

const ( // http://download.microsoft.com/download/9/c/5/9c5b2167-8017-4bae-9fde-d599bac8184a/pecoff_v83.docx
	_                                = 0x00000000 //	Reserved for future use.
	_                                = 0x00000001 //	Reserved for future use.
	_                                = 0x00000002 //	Reserved for future use.
	_                                = 0x00000004 //	Reserved for future use.
	...
	_                                = 0x00000010 //	Reserved for future use.
	...
	_                                = 0x00000400 //	Reserved for future use.
